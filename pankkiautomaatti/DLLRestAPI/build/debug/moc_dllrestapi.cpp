...
QT_MOC_LITERAL(1, 11, 9), // "sendToExe"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14) // "recieveBalance"

    },
    "DLLRestAPI\0sendToExe\0\0recieveBalance"
};
...
void DLLRestAPI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recieveBalance((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLRestAPI::sendToExe)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DLLRestAPI::sendToExe(QString _t1)
{
