...
QT_MOC_LITERAL(1, 14, 6), // "passID"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 2), // "ID"
QT_MOC_LITERAL(4, 25, 13) // "recieveSignal"

    },
    "DLLSerialPort\0passID\0\0ID\0recieveSignal"
};
...
void DLLSerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->passID((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->recieveSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLSerialPort::passID)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DLLSerialPort::passID(QString _t1)
{
